...
export class ActionGroup {
  ...
  private getTezosActions(): Action<any, any>[] {
    const importButtonAction = new ButtonAction({ name: 'account-transaction-list.import-accounts_label', icon: 'add' }, () => {
    ...
    const delegateButtonAction = new ButtonAction({ name: 'account-transaction-list.delegate_label', icon: 'logo-usd' }, () => {
  ...
  private getTezosKtActions(): Action<any, any>[] {
    const viewDelegateButtonAction = new ButtonAction({ name: 'account-transaction-list.delegate_label', icon: 'logo-usd' }, () => {
      const prepareDelegateActionContext = new SimpleAction(() => {
        return new Promise<AirGapDelegateActionContext>(async resolve => {
          const info = {
  ...
  private getEthereumActions(): Action<any, any>[] {
    const addTokenButtonAction = new ButtonAction({ name: 'account-transaction-list.add-tokens_label', icon: 'add' }, () => {
