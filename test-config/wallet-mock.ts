...
class WalletMock {
  ethWallet: AirGapMarketWallet = Object.assign(
  ...
  ethTransaction: Transaction = Object.assign(
    new Transaction(
      ['0x4681Df42ca7d5f0E986FFeA979A55c333f5c0a05'],
      ['0x579D75370dd53C59e09E6F51F4D935220D7EEcF8'],
      '10000000000000',
      '0',
      'eth'
    ),
  ...
  btcWallet: AirGapMarketWallet = new AirGapMarketWallet(
    'btc',
    'xpub6CcLgL3yuTNxguFdSikacKj93R77GMToq1488BKLdZMAQ2BfrVQrx31phHwqhx4kRUTNCeyiWiqvppaykiXM9w8RWJFbhj1etsCgBckA2bF',
    false,
    "m/44'/0'/0'"
  )
  btcTransaction: Transaction = Object.assign(
    new Transaction(['1JzeZaZwb1gLxQEwexUn4XmZ3tmSfuesBo'], ['1JzeZaZwb1gLxQEwexUn4XmZ3tmSfuesBo'], '10000000000000', '0', 'btc'),
    {
      payload: {
        ins: [
          {
